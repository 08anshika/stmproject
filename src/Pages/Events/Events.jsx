            ...
            <div className="col-lg-12">
              <ul className="nav custom-tab" id="myTab" role="tablist">
                <li className="nav-item">
                  <Link className="nav-link active show" id="home-taThursday" data-toggle="tab" to="#home" role="tab" aria-controls="home" aria-selected="true">Day 1</Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" id="profile-tab" data-toggle="tab" to="#profile" role="tab" aria-controls="profile" aria-selected="false">Day 2</Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" id="contact-tab" data-toggle="tab" to="#contact" role="tab" aria-controls="contact" aria-selected="false">Day 3</Link>
                </li>
                <li className="nav-item d-none d-lg-block">
                  <Link className="nav-link" id="sunday-tab" data-toggle="tab" to="#sunday" role="tab" aria-controls="sunday" aria-selected="false">Day 4</Link>
                </li>
                <li className="nav-item mr-0 d-none d-lg-block">
                  <Link className="nav-link" id="monday-tab" data-toggle="tab" to="#monday" role="tab" aria-controls="monday" aria-selected="false">Day 5</Link>
                </li>
              </ul>
